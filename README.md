...
感谢你对 Juhe Studio 感兴趣！我们欢迎各种形式的贡献。

### 如何参与

- 🐛 **报告问题**：通过 [GitHub Issues](../../issues) 提交 Bug 或功能建议
- 🔧 **提交代码**：Fork 仓库 → 创建分支 → 提交 Pull Request
- 📖 **改进文档**：帮助完善 README、注释、设计文档
- 💡 **功能建议**：在 Issues 中讨论新想法

### 开发前请了解

- 本项目使用 [MIT License](LICENSE)，贡献代码即表示你同意在该协议下发布
- 提交 Pull Request 前请确保代码可正常运行
- 较大改动建议先开 Issue 讨论，避免重复劳动

### 代码风格

| 项目 | 规范 |
|------|------|
| `pc/` / `admin/` | ESLint + Biome + TypeScript strict |
| `server/` | Go 标准 `gofmt` |
| `sdk/` | ESLint + TypeScript |
