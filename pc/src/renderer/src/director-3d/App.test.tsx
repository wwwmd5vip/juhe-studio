...
it.skip('renders the director desk editor (home screen removed in Task 4)', () => {
  // TODO: rewrite this test for the pc/ single-desk entry after Task 17 runtime verification
})
