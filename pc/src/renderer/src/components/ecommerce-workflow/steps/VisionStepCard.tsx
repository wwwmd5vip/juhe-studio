...
export function VisionStepCard({ step, stepState }: VisionStepCardProps) {
  ...
  useEffect(() => {
    if (config.providerId || config.modelId) return // already configured
    ...
    async function autoSelect() {
      try {
        ...
        // Search providers for the model, prefer juhe-management
        ...
        // Server not configured or not reachable — stay with empty defaults
      }
    }
