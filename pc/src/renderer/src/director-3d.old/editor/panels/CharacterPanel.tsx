...
export function CharacterPanel() {
  ...
  const poseGroups = [
    ...
    },
    {
      title: "左手",
      controls: [
        { key: "leftHand.pitch", label: "俯仰" },
        { key: "leftHand.roll", label: "翻转" },
        { key: "leftHand.twist", label: "扭转" },
      ],
    },
    {
      title: "右手",
      controls: [
        { key: "rightHand.pitch", label: "俯仰" },
        { key: "rightHand.roll", label: "翻转" },
        { key: "rightHand.twist", label: "扭转" },
      ],
    },
    {
      title: "左脚",
      controls: [
        { key: "leftFoot.pitch", label: "俯仰" },
        { key: "leftFoot.roll", label: "翻转" },
        { key: "leftFoot.twist", label: "扭转" },
      ],
    },
    {
      title: "右脚",
      controls: [
        { key: "rightFoot.pitch", label: "俯仰" },
        { key: "rightFoot.roll", label: "翻转" },
        { key: "rightFoot.twist", label: "扭转" },
      ],
    },
  ] as const;
