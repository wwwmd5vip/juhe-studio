...
const BoltNewDark: IconComponent = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='none' viewBox='9 9 102 102' {...props}>
      <g clipPath={`url(#${iconId}-boltnewdark__a)`}>
        <path
          fill='#fff'
        ...
        />
        <g filter={`url(#${iconId}-boltnewdark__b)`}>
          <path
            fill='#000'
            fillRule='evenodd'
      ...
      <defs>
        <clipPath id={`${iconId}-boltnewdark__a`}>
          <path fill='#fff' d='M0 0H83V83H0z' transform='translate(19 18)' />
        </clipPath>
        <filter
          id={`${iconId}-boltnewdark__b`}
          width={41.5}
          height={51.875}
          x={39.75}
          y={33.563}
        ...
        >
          ...
          <feBlend in2='shape' result='effect1_innerShadow_37_6277' />
        </filter>
      </defs>
    </svg>
  )
