  ...
  return (
    ...
    >
      <AvatarFallback className='text-foreground bg-background'>
        <OpenrouterLight className='dark:hidden' style={{ width: size * 0.7, height: size * 0.7 }} />
        <OpenrouterDark className='hidden dark:block' style={{ width: size * 0.7, height: size * 0.7 }} />
      </AvatarFallback>
    </Avatar>
  )
}
