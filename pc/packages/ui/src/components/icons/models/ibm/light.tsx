...
const IbmLight: IconComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='none' viewBox='0 0 200 200' {...props}>
    <path fill='#1D67AC' d='M0 0 C66 0 132 0 200 0 C200 66 200 132 200 200 C134 200 68 200 0 200 C0 134 0 68 0 0 Z' />
    <path
      fill='#CDDDEC'
    ...
    <path
      fill='#EFF4F9'
      d='M0 0 C13.86 0 27.72 0 42 0 C41.67 1.32 41.34 2.64 41 4 C27.47 4 13.94 4 0 4 C0 2.68 0 1.36 0 0 Z'
      transform='translate(62 116)'
    />
    <path
      fill='#EFF4F9'
      d='M0 0 C13.53 0 27.06 0 41 0 C41.5 1.98 41.5 1.98 42 4 C28.14 4 14.28 4 0 4 C0 2.68 0 1.36 0 0 Z'
    ...
    <path
      fill='#E2EBF4'
      d='M0 0 C10.89 0 21.78 0 33 0 C32.34 1.32 31.68 2.64 31 4 C20.77 4 10.54 4 0 4 C0 2.68 0 1.36 0 0 Z'
      transform='translate(70 94)'
    />
    <path
      fill='#E3ECF4'
    ...
    <path
      fill='#EBF2F8'
      d='M0 0 C8.25 0 16.5 0 25 0 C25.33 1.32 25.66 2.64 26 4 C17.42 4 8.84 4 0 4 C0 2.68 0 1.36 0 0 Z'
      transform='translate(107 80)'
    />
    <path
      fill='#EFF4F9'
      d='M0 0 C7.92 0 15.84 0 24 0 C24 1.32 24 2.64 24 4 C15.75 4 7.5 4 -1 4 C-0.67 2.68 -0.34 1.36 0 0 Z'
    ...
    <path
      fill='#EDF3F8'
      d='M0 0 C6.6 0 13.2 0 20 0 C20.33 1.32 20.66 2.64 21 4 C14.07 4 7.14 4 0 4 C0 2.68 0 1.36 0 0 Z'
    ...
    <path
      fill='#E4EDF5'
      d='M0 0 C5.94 0 11.88 0 18 0 C17.67 1.32 17.34 2.64 17 4 C11.72 4 6.44 4 1 4 C0.67 2.68 0.34 1.36 0 0 Z'
      transform='translate(129 102)'
    />
    <path
      fill='#E6EEF6'
      d='M0 0 C4.29 0 8.58 0 13 0 C13 1.32 13 2.64 13 4 C8.71 4 4.42 4 0 4 C0 2.68 0 1.36 0 0 Z'
      transform='translate(92 109)'
    />
    <path
      fill='#E8EFF6'
      d='M0 0 C4.29 0 8.58 0 13 0 C12.67 1.32 12.34 2.64 12 4 C8.04 4 4.08 4 0 4 C0 2.68 0 1.36 0 0 Z'
    ...
    <path
      fill='#E2EBF4'
      d='M0 0 C2.64 0 5.28 0 8 0 C7.67 1.32 7.34 2.64 7 4 C5.02 4 3.04 4 1 4 C0.67 2.68 0.34 1.36 0 0 Z'
