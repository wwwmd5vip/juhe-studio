...
const SoraLight: IconComponent = (props: SVGProps<SVGSVGElement>) => {
  const iconId = useId()
  ...
  return (
    ...
    >
      ...
      />
      <path fill={`url(#${iconId}-soralight__b)`} d='M9.726 11.36a.306.306 0 110 .612.306.306 0 010-.612z' />
      <path
        fill={`url(#${iconId}-soralight__c)`}
        fillRule='evenodd'
        ...
        clipRule='evenodd'
      />
      <path fill={`url(#${iconId}-soralight__d)`} d='M14.87 9.982a.307.307 0 110 .613.307.307 0 010-.613z' />
      <path
        fill={`url(#${iconId}-soralight__e)`}
        fillRule='evenodd'
      ...
      />
      <defs>
        <linearGradient id={`${iconId}-soralight__a`} x1={12} x2={12} y1={0} y2={24} gradientUnits='userSpaceOnUse'>
          <stop stopColor='#012659' />
          <stop offset={1} stopColor='#0968DA' />
        </linearGradient>
        <linearGradient
          id={`${iconId}-soralight__b`}
          x1={9.859}
          x2={14.219}
          y1={3}
          y2={21.017}
