...
const ClaudeCode: IconComponent = (props: SVGProps<SVGSVGElement>) => {
  const iconId = useId()
  ...
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath={`url(#${iconId}-claudecode__a)`}>
        <path
          fill='#D97757'
          fillRule='evenodd'
      ...
      <defs>
        <clipPath id={`${iconId}-claudecode__a`}>
          <path fill='#fff' d='M0 0H86V86H0z' transform='translate(16.5 16.5)' />
        </clipPath>
      </defs>
    </svg>
  )
