...
const IflowCli: IconComponent = (props: SVGProps<SVGSVGElement>) => {
  const iconId = useId()
  ...
  return (
    <svg
      ...
      height='1em'
      fill='none'
      viewBox='16 14.129 88 90.271'
      {...props}
    >
      <g clipPath={`url(#${iconId}-iflowcli__a)`}>
        <path
          fill={`url(#${iconId}-iflowcli__b)`}
      ...
      <defs>
        ...
        <clipPath id={`${iconId}-iflowcli__a`}>
